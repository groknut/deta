# Deta Viewer - Техническая спецификация
### 1. Общая информация
...
|CSV   |.csv      |
|SQL   |.sql      |
|Binary|.hex и нереализованные расширения файлов|
...
#### 2.3. Управление в TUI
Управление реализовано через конфиг `~/.config/deta.toml`
...
|-------|------------------|------------|
|Заголовок таблицы|	#957fb8 (фиолетовый)|	Фон заголовков|
|Строки данных| #223249 (темно-синий)|	Фон выделенной строки|
